...
const CliInstallation = ({ cliDefault, cliTailwind, cliTsDefault, cliTsTailwind }) => {
  ...
  return (
    <Box>
      ...
      {installConfigs.map(({ title, code }) => (
        <Box key={title} mb={6}>
          <Text mb={0} fontWeight="600" fontSize="1.4rem" color="#a6a6a6" className="demo-title-extra">
            {title}
          </Text>
      ...
      <Accordion.Root type="single" collapsible defaultValue="setup">
        <Accordion.Item value="setup" bg="#060010" border="1px solid #392e4e" borderRadius="20px">
          ...
          <Accordion.ItemContent px={6} pb={8}>
            <Text className="demo-extra-info">1. Initialize a config file for your project</Text>
            ...
            <Text className="demo-extra-info">2. Browse &amp; add components from the list</Text>
            ...
            <CodeHighlighter language="bash" codeString="npx jsrepo add Animations/AnimatedContent" />
